                  ...
                  <aside class="profile-info col-lg-9">
                      <section class="panel">
                          <header class="panel-heading">
                              Upload Multiple images in Work Gallery
                          </header>
                          <div class="panel-body">
		<form id="imageform" method="post" enctype="multipart/form-data" action="ajaxwork.php" style="clear:both">
...
?>
						  ...
						  <img width="260" height="170" style="" src="uploads/<?php echo $wk_timg; ?>" class="imgList">
						  </div>
						  <div class="error-mark"><a onclick="dltimg('<?php echo $wk_id; ?>','<?php echo $wk_timg; ?>')" href="#"><i class="fa fa-trash-o"></i></a></div>
						  </section>
						  </div>
<?php } ?>
					 </div>
