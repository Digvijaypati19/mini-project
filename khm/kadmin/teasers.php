                    ...
                    <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="fform" action="add_vid.php" method="post">
                                   <div class="form-group">
								   <div  class="col-lg-2 col-sm-2 control-label">Teaser Name </div>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="vname" id="vname" placeholder="Teaser Name">
                                      </div>
                                  </div>
                                   <div class="form-group">
								   <div  class="col-lg-2 col-sm-2 control-label"> Teaser link</div>
                                      <div class="col-lg-10">
                                          <input type="text"  class="form-control" name="link" id="link" placeholder="Teaser link">
                                      </div>
                                  </div>
                                  <div class="form-group">
